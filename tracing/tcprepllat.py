...
b.attach_kretprobe(event="tcp_sendmsg_locked", fn_name="trace_ret_tcp_sendmsg_locked", maxactive=4096)
b.attach_kprobe(event="tcp_recvmsg", fn_name="trace_tcp_recvmsg")
b.attach_kretprobe(event="tcp_recvmsg", fn_name="trace_ret_tcp_recvmsg", maxactive=4096)
